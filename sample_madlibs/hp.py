def madlib():
    ...
    madlib = f"A {adj1} glow burst suddenly across the enchanted sky above them as an edge of \
        dazzling sun appeard over the sill of the nears {noun1}. The light hit both of their {body_part} \
...
head of Nagini, spinning through the air toward the master it would not {verb1}, who had \
